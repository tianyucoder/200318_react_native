	...
	render() {
		return (
			<View>
				{/* 引入本地图片 */}
				<Image 
					source={require('../../imgs/car.jpg')}
					style={{width:300,height:370,backgroundColor:'skyblue'}}
					//参考https://reactnative.cn/docs/image#resizemode
					resizeMode="contain" //缩放模式
				/>

				{/* 引入网络图片 */}
				<Image
					source={{uri:'https://pic4.zhimg.com/80/v2-a47051e92cf74930bedd7469978e6c08_hd.png'}}
